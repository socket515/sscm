...
--
-- Table structure for table `teache`
--
...
CREATE TABLE `teache` (
  `tno` varchar(15) NOT NULL DEFAULT '0' COMMENT '教师号',
  ...
  PRIMARY KEY (`tno`),
  UNIQUE KEY `tdept_UNIQUE` (`tdept`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='教师表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `teache`
--

LOCK TABLES `teache` WRITE;
...
-- Dump completed on 2017-12-28 18:31:17
