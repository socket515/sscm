...
CREATE TABLE `arrange` (
  ...
  `anum` int(11) unsigned zerofill NOT NULL DEFAULT '00000000000' COMMENT '剩余人数',
  `maxnum` int(11) NOT NULL DEFAULT '0' COMMENT '最大人数',
  `atime` int(11) NOT NULL DEFAULT '0' COMMENT '课程时间',
  `address` varchar(31) CHARACTER SET gbk NOT NULL DEFAULT '' COMMENT '地点',
  PRIMARY KEY (`cno`),
  KEY `fk_arrange_2_idx` (`tno`)
...
-- Dump completed on 2017-12-28 18:31:20
